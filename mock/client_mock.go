...
// 2018-12-29T14:38:47-06:00
// using the command
// $ go-mockgen github.com/efritz/deepjoy -i Client -d mock -f
...
// package github.com/efritz/deepjoy) used for unit testing.
...
func NewMockClientFrom(i deepjoy.Client) *MockClient {
	return &MockClient{
		CloseFunc: &ClientCloseFunc{
			defaultHook: i.Close,
		},
